        ...
        if (event == "telemetry") {
          ...
          if (!pf.initialized()) {
            ...
            // return;
    			   ...
    			   // cout << "[previous_velocity, previous_yawrate]: " << previous_velocity << ", "<< previous_yawrate << endl;
          ...
          cout << "[sense_observations_x, sense_observations_y]: " << sense_observations_x << ", "<< sense_observations_y << endl;
